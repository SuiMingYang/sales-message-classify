...
class TopicMessageEncoder:
    ...
    def encode(req):
        ...
        msgbody = req.message_body.encode('utf-8') if isinstance(req.message_body, str) else req.message_body
    ...
    def decode(xml_data, req_id=None):
        ...
        try:
            for data_dic in data_listofdic:
                ...
                msg.consumed_times = int(data_dic["ConsumedTimes"])#string\.atoi
