...
if __name__ == '__main__':
    time1=datetime.now()
    detect_obj=Detect()
    result=detect_obj.detectFaces('./resource/pic/heat.jpg')
    time2=datetime.now()
    ...
    #detect_obj.drawFaces('./resources/pic/face.jpg')
    #drawEyes('./resources/pic/slx.jpg')
    # drawSmiles('obama.jpg')
    #detect_obj.saveFaces('obama.jpg')
    import requests

    # 在线解码器
    url1 = "https://img.alichat.loveutips.com/alichat_img/2019-04-23/9f9410264fa605b94c1f32ab267bc3eb.jpg"
